...
inline void BaseElement<ElementTypeT>::Load(std::istream& istr)
{
    Reader::Read(*(ElementTypeT*)this, istr);
}

template <typename ElementTypeT>
inline void BaseElement<ElementTypeT>::Dump(std::ostream& ostr, bool compact) const
{
    Writer::Write(*(ElementTypeT*)this, ostr, compact);
}

template<typename ElementTypeT>
inline void BaseElement<ElementTypeT>::Parse(const std::string& str)
{
    if (!str.empty())
    {
...
template<typename ElementTypeT>
inline std::string BaseElement<ElementTypeT>::Pack(bool compact) const
{
...
ElementTypeT& UnknownElement::ConvertTo() 
{
   ...
   if (castVisitor.m_pElement == 0)
   {
      ...
      *this = UnknownElement(ElementTypeT());
      m_pImp->Accept(castVisitor);
   }
...
inline ElementType UnknownElement::Type() const
{
    return m_pImp->Type();
}

inline void UnknownElement::Dump(std::ostream& ostr, bool compact) const
{
    switch (Type())
    {
    case TYPE_STRING:
        Writer::WriteString(*this, ostr);
        break;
    case TYPE_NUMBER:
    case TYPE_BOOLEAN:
    case TYPE_NULL:
    ...
    case TYPE_ARRAY:
    default:
        Writer::Write(*this, ostr, compact);
        break;
    }
}
inline const std::string & UnknownElement::ToString() const
{
    return CastTo<String>().Value();
}
inline const double & UnknownElement::ToNumber() const
{
    return CastTo<Number>().Value();
}
inline const bool & UnknownElement::ToBoolean() const
{
    return CastTo<Boolean>().Value();
}

inline UnknownElement& UnknownElement::operator = (const std::string & value)
{
    return *this = UnknownElement(String(value));
}
inline UnknownElement& UnknownElement::operator = (const char * value)
{
    return *this = UnknownElement(String(value));
}
inline UnknownElement& UnknownElement::operator = (const long & value)
{
    return *this = UnknownElement(Number(value));
}
inline UnknownElement& UnknownElement::operator = (const long long & value)
{
    return *this = UnknownElement(Number((double)value));
}
inline UnknownElement& UnknownElement::operator = (const unsigned long & value)
{
    return *this = UnknownElement(Number(value));
}
inline UnknownElement& UnknownElement::operator = (const unsigned long long & value)
{
    return *this = UnknownElement(Number((double)value));
}
inline UnknownElement& UnknownElement::operator = (const float & value)
{
    return *this = UnknownElement(Number(value));
}
inline UnknownElement& UnknownElement::operator = (const double & value)
{
    return *this = UnknownElement(Number(value));
}
inline UnknownElement& UnknownElement::operator = (const bool & value)
{
    return *this = UnknownElement(Boolean(value));
}
...
inline Object::Object(const std::string& str)
{
    Parse(str);
}
...
inline ElementType Object::Type() const
{
    return TYPE_OBJECT;
}
...
inline Array::Array(const std::string& str)
{
    Parse(str);
}
...
inline ElementType Array::Type() const
{
    return TYPE_ARRAY;
}
...
template<> inline ElementType TrivialType_T<double>::Type() const
{
    return TYPE_NUMBER;
}
template<> inline ElementType TrivialType_T<bool>::Type() const
{
    return TYPE_BOOLEAN;
}
template<> inline ElementType TrivialType_T<std::string>::Type() const
{
    return TYPE_STRING;
}
...
inline ElementType Null::Type() const
{
    return TYPE_NULL;
}
